...
function NivelModal({ data, showModal, funcion }) {
    return (
        <div className="modal" style={{ display: 'block', backgroundColor: 'rgba(64, 64, 64, 0.5)' }}>
            <div className="modal-dialog">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title">Fomulario de niveles de enfermería</h5>
                    ...
                    <div className="modal-body">
                        <fieldset>
                            <Formik
                                initialValues={{ id: data.NIV_ID || 0, nombre: data.NIV_NOMBRE || "" }}
                                validate={values => {
                                    const errors = {}
                                    if (!values.nombre) {
                                        errors.nombre = 'Nombre de nivel requerido'
                                    }
                                    return errors
                                }}
                            ...
                            >
                                {({ isSubmitting }) => (
                                    <Form>
                                        ...
                                        <div className="form-group">
                                            <label className="col-form-label mt-4" >Nivel</label>
