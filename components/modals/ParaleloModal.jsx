...
function ParaleloModal({ data, showModal, funcion }) {
    return (
            ...
            <div className="modal-dialog">
                <div className="modal-content">
                    ...
                    <div className="modal-body">
                        <fieldset>
                            <Formik
                                initialValues={{ id: data.PAR_ID || 0, nombre: data.PAR_NOMBRE || "" }}
                                validate={values => {
                                    const errors = {}
                                    if (!values.nombre) {
                                        errors.nombre = 'Nombre de paralelo requerido'
                                    }
                                    return errors
                                }}
                            ...
                            >
                                {({ isSubmitting }) => (
                                    <Form>
                                        ...
                                        <div className="form-group">
                                            <label className="col-form-label mt-4" >Paralelo</label>
